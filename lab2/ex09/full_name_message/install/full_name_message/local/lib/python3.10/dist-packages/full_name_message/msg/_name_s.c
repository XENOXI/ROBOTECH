...
bool full_name_message__msg__name__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("full_name_message.msg._name.Name", full_classname_dest, 32) == 0);
  }
  full_name_message__msg__Name * ros_message = _ros_message;
  {  // last_name
...
{
  /* NOTE(esteve): Call constructor of Name */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("full_name_message.msg._name");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Name");
